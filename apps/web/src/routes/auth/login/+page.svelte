...
<form class="place-self-center max-w-[400px] flex flex-col w-full bg-grey-600 p-8 rounded-[20px]" use:enhance method="POST">
  <h2 class="font-outfit mb-10 text-white text-[2rem]">Login</h2>
  ...
  <Button class="mb-6 transition-colors bg-red-600 text-white hocus:bg-white hocus:text-grey-600">Login to your account</Button>
  <p class="mx-auto text-white font-outfit text-[15px] text-center">
    Don’t have an account? <a class="text-red-300" href="/auth/register">Sign up</a>
  </p>
</form>
